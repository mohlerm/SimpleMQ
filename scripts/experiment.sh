...
screen -dmS python_experiment_$experimentId python3 graphs.py $clientCount $experimentId
screen -dmS python_experiment_server_$experimentId python3 graphs_server.py $clientCount $experimentId
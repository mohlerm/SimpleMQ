...
experimentConstant=longTrace
i=30
#for i in {10..30..5} #{5..20..5}
#  do
    bash experiment.sh --dbMachine=$dbMachine --dbPersistent=false --serverMachines=$serverMachines --serverWorkerTotal=64 --clientMachines=$clientMachines --clientTotal=$i --clientWorkload=staticsmall --clientRunTime=2000 --clientRunCount=-1 --remoteUserName=ubuntu --experimentId=$experimentConstant$i
